...
CREATE TABLE `bento` (
  `id_bento` int(11) NOT NULL AUTO_INCREMENT,
...
(3,'Bento rapide','Bento fait à l’arrache mais ça nourrit',2,'2025-12-27 17:41:36',''),
...
(6,'Bento zéro motivation','Quand t’as faim mais aucune envie de cuisiner',2,'2025-12-27 17:41:36',''),
(7,'Bento random','On met ce qu’on trouve et on voit après',1,'2025-12-27 17:41:36',''),
(8,'Bento Italien','Mamma mia dans ton bento!',5,'2026-01-08 13:54:58',NULL),
...
(12,'Bento Italien classique','Un air d\'Italie dans chaque bouchée!',5,'2026-01-08 13:54:58',NULL),
(13,'Bento Fraîcheur','Le bento qui respire!',5,'2026-01-08 13:54:58',NULL),
...
(17,'Bento Protéiné','Mange-le, il fait le travail.',5,'2026-01-08 13:54:58',NULL),
...
(20,'Bento Réconfort','Comme à la maison!',5,'2026-01-08 13:54:58',NULL),
(21,'BentoCharp','',6,'2026-01-14 13:28:43',NULL);
...
CREATE TABLE `bento_recettes` (
  `id_bento` int(11) NOT NULL,
  `id_recette` int(11) NOT NULL,
  KEY `fk_bento_recettes_bento` (`id_bento`),
  KEY `fk_recette_bento_recette` (`id_recette`),
  CONSTRAINT `fk_bento_recettes_bento` FOREIGN KEY (`id_bento`) REFERENCES `bento` (`id_bento`),
  CONSTRAINT `fk_recette_bento_recette` FOREIGN KEY (`id_recette`) REFERENCES `recette` (`id_recette`)
...
INSERT INTO `bento_recettes` VALUES
(1,1),
(2,2),
(3,2),
(4,3),
...
CREATE TABLE `enregistrements` (
  `id_enregistrements` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `etapes_recettes` (
  ...
  CONSTRAINT `fk_recette_etapes` FOREIGN KEY (`id_recette`) REFERENCES `recette` (`id_recette`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `etapes_recettes` VALUES
...
CREATE TABLE `ingredients_recettes` (
  ...
  CONSTRAINT `recette` FOREIGN KEY (`id_recette`) REFERENCES `recette` (`id_recette`),
  CONSTRAINT `unit` FOREIGN KEY (`unites`) REFERENCES `unites` (`id_unites`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ingredients_recettes` VALUES
(5,1,27,1),
(12,1,NULL,5),
(8,1,67,1),
(6,1,NULL,1),
...
CREATE TABLE `recette` (
  ...
  CONSTRAINT `fk_recette_type` FOREIGN KEY (`id_type`) REFERENCES `type_recette` (`id_type`),
  CONSTRAINT `user recette` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
...
LOCK TABLES `type_recette` WRITE;
/*!40000 ALTER TABLE `type_recette` DISABLE KEYS */;
INSERT INTO `type_recette` VALUES
(1,'Entrée'),
(2,'Plat'),
(3,'Dessert'),
(4,'Autre');
/*!40000 ALTER TABLE `type_recette` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `unites` (
  `id_unites` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `user` (
  ...
  `tag_allergie` text DEFAULT NULL,
  `photo` text DEFAULT NULL,
  `nb_bento` int(11) NOT NULL DEFAULT 1,
...
(1,'admin','Pouco','Jane','{}',NULL,1,'Administrateur du site.','$2y$10$XXFLXbP9yb5bRutVi0VBGuKJ681NdaJDy0hzbRVEAVdyhdByVarBu','leolesimple@icloud.com','2025-12-10 08:51:59','admin'),
(2,'leolesimple','Lesimple','Léo',NULL,'uploads/profiles/loty_leolesimple_1766770009.png',1,'Développeur du site LOTY','$2y$10$DtOz8lUHg6m5uAzmjnYvfuxplj/XAHr6qk75/mv0djEwMEyVptClC','leo.lesimple@edu.univ-eiffel.fr','2025-12-26 18:26:49','user'),
(5,'profs','Les Profs','MMI',NULL,'/uploads/profiles/loty_profs_1768066133.jpeg',1,'Nous corrigeons cette SAÉ','$2y$10$PbwjjIi1MsIwRDgkRBMCB.UZ9lAKGM42kIbRFPHQLHJFb7d/eniPC','profs@getloty.fr','2026-01-10 18:28:53','admin'),
(6,'Gaelle','Charpentier','Gaelle',NULL,'/uploads/profiles/loty_Gaelle_1768393463.jpg',1,'Vive le Bento !','$2y$10$L5cm88tTx4tEsclDoIE.h.JSc5UPVWvp0BbVBV7Q/kBU/QQ9AFSZK','gaelle.charpentier@univ-eiffel.fr','2026-01-14 13:24:23','user'),
(7,'matthieu','berthet','Matthieu',NULL,'/uploads/profiles/loty_matthieu_1768471617.png',1,'sdfsdf','$2y$10$27BFy423cx6myIyjcGGai.cOQeMAYbIjVkaCUVon4m2ot6JWLt8oS','matthieu.berthet@free.fr','2026-01-15 11:06:57','user');
...
-- Dump completed on 2026-01-21 19:11:46
